...
function generateAccessToken(id,name,ispremiumuser){ 
    return jwt.sign({userId:id,name:name,ispremiumuser},'u3h437843hf374y3yrhdfy3487347843yfh##@#4dfdwdsd32d#$Q#@cr3w#')
}

exports.getpremiummembership= async (req, res, next)=>{
    try{
        var rzp=new Razorpay({ 
            key_id: 'rzp_test_jn4cTtjidJWKhS',
            key_secret: '86vMUd2tEDxdbCV25qxdyzTZ'
        })
        const amount=2500; 
